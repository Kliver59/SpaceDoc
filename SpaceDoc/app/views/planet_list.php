...
<head>
    ...
    <link rel="stylesheet" href="/SpaceDoc/public/css/style.css">
</head>
<body>
    ...
    <div class="planetes-container">
        <?php foreach ($planetes as $planete): ?>
            <div class="planete">
                ...
                <img src="/SpaceDoc/public/images/<?= htmlspecialchars($planete->getImage()) ?>" alt="<?= htmlspecialchars($planete->getNom()) ?>">
            </div>
        <?php endforeach; ?>
    </div>
    <script src="/SpaceDoc/public/js/script.js"></script>
</body>
</html>